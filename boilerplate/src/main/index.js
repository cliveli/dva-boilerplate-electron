...
app.on('ready', () => {
  ...
  if (is.dev()) {
    BrowserWindow.addDevToolsExtension(join($dirname, '../../extensions/redux-devtools/2.11.1_0')); // eslint-disable-line no-undef
    BrowserWindow.addDevToolsExtension(join($dirname, '../../extensions/react-developer-tools/0.15.4_0')); // eslint-disable-line no-undef
  }
});
